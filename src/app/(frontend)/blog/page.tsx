  ...
  return (
    <div className="py-20 px-6 lg:px-12 max-w-5xl mx-auto">
      ...
      <div className="mb-12 border-b border-oxford-border/60 pb-8">
        ...
        <p className="mt-3 text-base sm:text-lg text-slate-400 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {posts.map((post) => (
          ...
          >
            <div>
              ...
              <CardContent className="p-6">
                ...
                <Link href={`/blog/${post.slug}`}>
                  <h2 className="text-xl font-bold font-mono text-slate-100 group-hover:text-sun transition-colors leading-snug">
                    {post.title}
                  </h2>
                </Link>
            ...
            <div className="border-t border-oxford-border/60 px-6 py-4 flex items-center justify-between">
